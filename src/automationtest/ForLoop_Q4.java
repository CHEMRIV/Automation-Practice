...
4.2 Create a method with the name "printMyName" with no return type and two parameters with the type string and name "name" and
 int type name 'howManyTime'.
...
public class ForLoop_Q4 {
    ...
    public static void main(String[] args) {
        ...
        obj.printMyName("Beena", 10);
        obj.printMyName("Beena", 15);
